...
const transactionsRoutes = require('./routes/transactions.js'); // Importa as rotas de transações
...
//Usar as rotas de transações para as requisições que cmeçam com /api/transaction
app.use('./api/transactions', transactionsRoutes)

// Rota inicial para testar o servidor
app.get('/', (req, res) => {
    res.send('hello, world');                   // definir uma rota para testar o servidor
});
